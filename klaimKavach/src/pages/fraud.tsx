    ...
    <div className="max-w-xl mx-auto w-full space-y-8 pb-20">
          ...
          <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground flex items-center gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs">
                AI analyzes trip history, GPS telematics, and previous claim patterns to generate your trust score. High scores ensure instant payouts.
              </TooltipContent>
            </Tooltip>
          </h1>
          <p className="text-muted-foreground mt-1 text-sm">Real-time fraud prevention engine.</p>
        </div>
      </div>

      <Card className="p-8 md:p-12 flex flex-col items-center justify-center text-center">
        <div className={`w-16 h-16 rounded-full ${bgClass}/10 flex items-center justify-center mb-8`}>
        ...
        <div className="w-full max-w-sm mb-10 relative">
          ...
          >
            <div className="flex items-baseline gap-1">
              <span className={`text-6xl font-bold tracking-tight tabular-nums ${colorClass}`}>
        ...
        <div className="mt-4 pt-8 border-t border-border w-full text-left">
          <h3 className="text-sm font-semibold uppercase tracking-widest text-foreground mb-2">{fraudData.label}</h3>
          <p className="text-muted-foreground text-sm">
            {fraudData.details || "Your account is in good standing. Claims under ₹2,000 will be processed instantly."}
          </p>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-card border border-border rounded-xl p-5">
          <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold mb-2">Status</p>
          <p className="text-sm text-foreground font-medium capitalize">{fraudData.status}</p>
        </div>
        <div className="bg-card border border-border rounded-xl p-5">
          <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold mb-2">Telematics Auth</p>
          <p className="text-sm text-emerald-500 font-medium">Synced & Active ✓</p>
        </div>
      </div>
    </div>
  );
